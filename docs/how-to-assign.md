...
3. Click the dropdown and then click the *Copy* button   
![assign1](https://mnfhs.sharepoint.com/sites/LearningManagementSystem/Shared%20Documents/OngoingCompetency/assign-1.png)
5. Fill out the Title
6. Click the *X* button for the *Cornerstone Content Development Training* placeholder
7. Click the *Select Training* button
8. Search for the Curriculum
9. Check the select box for the curriculum and click the *Select* button
10. Click the *Next* button until you reach the *Users* page
11. Click the *Select Users* button   
![assign2](https://mnfhs.sharepoint.com/sites/LearningManagementSystem/Shared%20Documents/OngoingCompetency/assign-2.png)
12. Click the *Users* dropdown and select the *Group* option
