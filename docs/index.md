...
Use this guide to create and maintain Ongoing Competency learning objects in Cornerstone. Reach out to the LMS Team (LMS@fairview.org) with any questions.

[Insert teams links for office hours]
...
- Curriculum structure should have a single Introduction material (PDF) with links to various resources rather than an individual training object for each optional resource.
